    ...
    if (state.weatherData && state.weatherData.list) {
      ...
      return allDates.map((date, index) => {
        ...
        const getWeatherIcon = (condition) => {
          switch (condition) {
            case "Clear":
              return require("./SVG/01d.svg").default;
            case "clear sky":
              return require("./SVG/01d.svg").default;
            case "light rain":
              return require("./SVG/09d.svg").default;

            case "Clouds":
              return require("./SVG/03d.svg").default;
            case "few clouds":
              return require("./SVG/04d.svg").default;
            case "overcast clouds":
              return require("./SVG/04d.svg").default;
            case "scattered clouds":
              return require("./SVG/11d.svg").default;
            case "broken clouds":
              return require("./SVG/03d.svg").default;

            case "snow":
              return require("./SVG/13d.svg").default;
            case "light snow":
              return require("./SVG/13d.svg").default;

            case "Rain":
              return require("./SVG/02d.svg").default;
